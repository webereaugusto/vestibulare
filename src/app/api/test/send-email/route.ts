...
export async function POST(req: Request) {
  try {
    ...
    if (type === 'alert') {
      ...
      sendSmtpEmail.htmlContent = `
        <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f8fafc; padding: 24px; border: 1px solid #e2e8f0;">
            <p style="color: #334155; font-size: 16px;">Ola, <strong>${profile.full_name || 'estudante'}</strong>!</p>
          ...
          <div style="background: #f1f5f9; padding: 16px; border-radius: 0 0 12px 12px; text-align: center;">
            <p style="color: #94a3b8; font-size: 12px; margin: 0;">
              Este e um email de TESTE do ZapVest.
            </p>
          </div>
        </div>
      `;
      ...
      sendSmtpEmail.subject = subject || 'Teste ZapVest - Email funcionando!';
      sendSmtpEmail.htmlContent = `
        <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
