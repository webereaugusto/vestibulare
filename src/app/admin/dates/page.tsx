        ...
        <CardContent className="p-4">
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <select
              ...
              className="h-10 rounded-lg border border-gray-300 bg-white px-3 text-sm text-gray-700 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 sm:w-48"
            >
            ...
            <select
              ...
              className="h-10 rounded-lg border border-gray-300 bg-white px-3 text-sm text-gray-700 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 sm:w-44"
            >
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3 min-w-0 flex-1">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="flex items-center gap-3 mt-0.5">
                      {d.official_url && (
                        <a href={d.official_url} target="_blank" rel="noopener noreferrer" className="text-xs text-emerald-600 hover:text-emerald-800 flex items-center gap-1">
                ...
                <div className="flex gap-1 flex-shrink-0">
                  <Button variant="ghost" size="icon" onClick={() => setBroadcastTarget(d)} title="Enviar alerta agora"><Send className="h-4 w-4 text-emerald-500" /></Button>
        ...
        {filteredDates.length === 0 && dates.length > 0 && (
          <Card>
            <CardContent className="p-8 text-center text-gray-500">
              ...
              <br />
              <button onClick={clearFilters} className="text-emerald-600 hover:underline mt-2 inline-block">
                Limpar filtros
              </button>
            </CardContent>
          </Card>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="flex w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 resize-none"
            />
          </div>
